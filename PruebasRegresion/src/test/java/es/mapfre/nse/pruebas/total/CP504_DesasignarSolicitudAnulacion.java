...
public class CP504_DesasignarSolicitudAnulacion extends NseBaseTestSubscriptor {

	public static String CODIGO_PRUEBA = "CP504";
	...
	public void consultarHistorialSubscripcionTest() {
		...
		paginaBusquedaAnulaciones.seleccionarValorCombo("12");
    	...
    	paginaBusquedaAnulaciones.pulsarBotonDesasignar();
