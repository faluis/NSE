...
public class CP404_DesasignarSolicitudOperacion extends NseBaseTestSubscriptor {

	public static String CODIGO_PRUEBA = "CP404";
	...
	public void consultarHistorialSubscripcionTest() {
    	...
    	paginaBusquedaSubscripciones.seleccionarValorCombo("12");
    	...
    	paginaBusquedaSubscripciones.pulsarBotonVerHistorial();
    	
    	paginaBusquedaSubscripciones.pulsarBotonAceptarVerHistorial();	
	}
