...
public class CP302_ConsultarControlesTecnicos extends NseBaseTest {
	...
	@Test
	public void consultarControlesTecnicosTest() {
    	...
    	paginaBusquedaSolicitudes.pulsarBotonControlesTecnicos();
    	
    	paginaBusquedaSolicitudes.pulsarBotonAceptarControlesTecnicos();
	}
