...
public class CP406_AutorizacionDirectaCentroTecnico extends NseBaseTestSubscriptor {

	public static String CODIGO_PRUEBA = "CP406";
	...
	public void consultarHistorialSubscripcionTest() {
    	...
    	paginaBusquedaSubscripciones.pulsarBotonAutorizarDirecta();
    	
    	//paginaBusquedaAnulaciones.setTextoAutorizacion("Autorizado");
    	
    	paginaBusquedaSubscripciones.pulsarBotonAutorizarDirectaInterna();	
    	
    	paginaBusquedaSubscripciones.pulsarBotonComandoDirecto();
	}
