...
public class CP502_ConsultarControlesTecnicos extends NseBaseTestSubscriptor {

	public static String CODIGO_PRUEBA = "CP502";
	...
	public void consultarControlesTecnicosSubscripcionTest() {
    	...
    	if(numeroResultados>1) {
    		paginaBusquedaAnulaciones.seleccionarResultadoBusqueda(1);
    	}
    	
    	paginaBusquedaAnulaciones.pulsarBotonControlesTecnicos();
    	
    	paginaBusquedaAnulaciones.pulsarBotonAceptarControlesTecnicos();
	}
